...
const routes = [
  ...
  // Trainer
  {
    ...
    children: [
      ...
      { path: 'clients/:clienteId/routine', component: () => import('../pages/trainer/ClientRoutine.vue') },
      { path: 'languages',                  component: () => import('../pages/shared/LanguagePage.vue') },
      { path: 'accessibility',component: () => import('../pages/shared/AccessibilityPage.vue') },
      { path: 'profile',      component: () => import('../pages/shared/ProfilePage.vue') },
    ],
  ...
  // Client
  {
    ...
    children: [
      ...
      { path: 'racha',        component: () => import('../pages/client/Racha.vue') },
      { path: 'goals',        component: () => import('../pages/client/Goals.vue') },
      { path: 'routine',      component: () => import('../pages/client/Routine.vue') },
      { path: 'languages',    component: () => import('../pages/shared/LanguagePage.vue') },
      { path: 'accessibility',component: () => import('../pages/shared/AccessibilityPage.vue') },
      { path: 'profile',      component: () => import('../pages/shared/ProfilePage.vue') },
    ],
